Description: A rule-based command-line chatbot built with Python. It parses user input, matches keywords from a dataset (bot.json), and replies with the most relevant response or a random fallback.
---
